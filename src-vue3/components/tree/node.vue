    ...
    <ul :class="classes">
      ...
      >
        ...
        <Tree-node
          ...
          ><template v-if="data.expand"> </template
        ></Tree-node>
      </li>
    </ul>
  </collapse-transition>
...
export default {
  ...
  computed: {
    ...
    arrowType() {
      ...
      if (window.$IVIEW) {
        if (window.$IVIEW.tree.customArrow) {
          type = ''
        } else if (window.$IVIEW.tree.arrow) {
          type = window.$IVIEW.tree.arrow
        }
      }
      return type
    },
    ...
    customArrowType() {
      ...
      if (window.$IVIEW) {
        if (window.$IVIEW.tree.customArrow) {
          type = window.$IVIEW.tree.customArrow
        }
      }
      return type
    },
    ...
    arrowSize() {
      ...
      if (window.$IVIEW) {
        if (window.$IVIEW.tree.arrowSize) {
          size = window.$IVIEW.tree.arrowSize
        }
      }
      return size
    },
